...
public class VersionOne implements Patch {
    ...
    public List<String> changes() {
        return Arrays.asList("CREATE TABLE IF NOT EXISTS users (username VARCHAR(255), password VARCHAR(255), growerID INTEGER PRIMARY KEY, salt VARCHAR(255), admin BOOLEAN)",
